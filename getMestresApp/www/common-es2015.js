...
class CategoryModel extends _baseModel__WEBPACK_IMPORTED_MODULE_0__["BaseModel"] {
}
...
let OrderService = class OrderService extends _base_service__WEBPACK_IMPORTED_MODULE_4__["BaseService"] {
    constructor(http) {
        super('request', http);
        this.http = http;
    }
...
let SubCategoryService = class SubCategoryService extends _base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(http) {
        super('subCategory', http);
        this.http = http;
    }
    getAllByCategory(categoryUid) {
