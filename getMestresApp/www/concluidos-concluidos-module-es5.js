...
var ConcluidosPageModule = /** @class */ (function () {
    function ConcluidosPageModule() {
    }
...
var ConcluidosPage = /** @class */ (function () {
    function ConcluidosPage(orderSrv) {
        this.orderSrv = orderSrv;
        this.list = [];
    }
    ConcluidosPage.prototype.ionViewWillEnter = function () {
        this.loadData();
    };
    ConcluidosPage.prototype.loadData = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, success, data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.orderSrv.getMyOrders(_models_enums_RequestStatus__WEBPACK_IMPORTED_MODULE_3__["RequestStatus"].finished)];
                    case 1:
    ...
    ConcluidosPage.ctorParameters = function () { return [
...
//# sourceMappingURL=concluidos-concluidos-module-es5.js.map