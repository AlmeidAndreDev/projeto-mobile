...
let NovaSolicitacaoSubCategoriaPageModule = class NovaSolicitacaoSubCategoriaPageModule {
};
...
let NovaSolicitacaoSubCategoriaPage = class NovaSolicitacaoSubCategoriaPage {
    constructor(router, subCategorySrv, navCtrl) {
        this.router = router;
    ...
    loadData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const result = yield this.subCategorySrv.getAllByCategory(this.category.uid);
            if (result.success) {
...
NovaSolicitacaoSubCategoriaPage.ctorParameters = () => [
...
//# sourceMappingURL=nova-solicitacao-sub-categoria-nova-solicitacao-sub-categoria-module-es2015.js.map