...
let PerfilPage = class PerfilPage {
    constructor(customerSrv, userSrv, alertCtrl, alertSrv, cameraSrv) {
    ...
    loadData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const { success, data } = yield this.customerSrv.GetById(this.userSrv.UserData.uid);
            if (success) {
                this.form = data;
                this.fixPathPhoto();
            }
    ...
    save() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const { success, data } = yield this.customerSrv.post(this.form);
            if (success) {
                this.form = data;
                this.fixPathPhoto();
    ...
    changePasswordHandle(currentPassword, newPassword, confirmNewPassword) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const { success } = yield this.customerSrv.changePassword(currentPassword, newPassword, confirmNewPassword);
            if (success) {
...
class CustomerModel extends _baseModel__WEBPACK_IMPORTED_MODULE_0__["BaseModel"] {
}
...
let CustomerService = class CustomerService extends _base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(http) {
        super('customer', http);
        this.http = http;
    }
