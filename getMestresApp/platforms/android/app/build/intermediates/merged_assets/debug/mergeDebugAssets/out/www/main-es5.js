...
var map = {
	"./login/login.module": [
		...
		"default~login-login-module~tabs-tabs-module",
		"login-login-module"
	]
};
...
var routes = [
    { path: '', loadChildren: function () { return Promise.all(/*! import() | tabs-tabs-module */[__webpack_require__.e("default~login-login-module~tabs-tabs-module"), __webpack_require__.e("tabs-tabs-module")]).then(__webpack_require__.bind(null, /*! ./tabs/tabs.module */ "./src/app/tabs/tabs.module.ts")).then(function (m) { return m.TabsPageModule; }); } },
...
module.exports = __webpack_require__(/*! C:\andre\faculdade\celular\getmestres-master\getmestres-master\getMestresApp\src\main.ts */"./src/main.ts");
