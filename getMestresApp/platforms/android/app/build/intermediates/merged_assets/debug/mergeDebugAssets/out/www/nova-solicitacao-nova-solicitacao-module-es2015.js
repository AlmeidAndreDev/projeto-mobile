...
let NovaSolicitacaoPageModule = class NovaSolicitacaoPageModule {
};
...
let NovaSolicitacaoPage = class NovaSolicitacaoPage {
    constructor(categorySrv, router) {
    ...
    loadData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const result = yield this.categorySrv.GetAll();
            if (result.success) {
...
NovaSolicitacaoPage.ctorParameters = () => [
...
//# sourceMappingURL=nova-solicitacao-nova-solicitacao-module-es2015.js.map