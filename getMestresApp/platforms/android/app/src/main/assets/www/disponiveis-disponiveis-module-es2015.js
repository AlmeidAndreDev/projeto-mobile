...
let DisponiveisPageModule = class DisponiveisPageModule {
};
...
let DisponiveisPage = class DisponiveisPage {
    ...
    loadData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const { success, data } = yield this.orderSrv.getOrdersAvailable();
            if (success) {
                this.list = data;
            }
        });
...
DisponiveisPage.ctorParameters = () => [
...
//# sourceMappingURL=disponiveis-disponiveis-module-es2015.js.map