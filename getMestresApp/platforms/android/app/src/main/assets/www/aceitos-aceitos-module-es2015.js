...
let AceitosPageModule = class AceitosPageModule {
};
...
let AceitosPage = class AceitosPage {
    ...
    loadData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const { success, data } = yield this.orderSrv.getMyOrders(_models_enums_RequestStatus__WEBPACK_IMPORTED_MODULE_3__["RequestStatus"].accepted);
            if (success) {
                this.list = data;
            }
        });
...
//# sourceMappingURL=aceitos-aceitos-module-es2015.js.map